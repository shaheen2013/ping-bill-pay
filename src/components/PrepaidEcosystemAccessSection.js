...
const PrepaidEcosystemAccessSection = () => {
  return (
    <div className="frame-parent44">
        ...
        <div className="frame-parent45">
          <div className="access-the-prepaid-ecosystem-i-parent">
            ...
            <div className="component-2">
              <div className="text27">Book a demo</div>
            </div>
          </div>
            ...
            <div className="user-reviews">
              <div className="avatar-group">
                <div className="avatar-group">
                  ...
                  <img className="avatar-icon1" alt="" src="/avatar2@2x.png" />
                  <img className="avatar-icon1" alt="" src="/avatar3@2x.png" />
                  <img className="avatar-icon1" alt="" src="/avatar4@2x.png" />
                </div>
              </div>
              <div className="reviews">
                <div className="row">
                  ...
                  <div className="text28">5.0</div>
                </div>
                <div className="text29">from 2000+ reviews</div>
              </div>
            </div>
      ...
      <div className="system-material-ultrathin-ligh-parent">
        <div className="system-material-ultrathin-ligh" />
        <img className="converted-1-icon" alt="" src="/36-converted-1.svg" />
      </div>
    </div>
  );
};

export default PrepaidEcosystemAccessSection;
