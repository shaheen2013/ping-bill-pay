            ...
            <div className="content-item7">
              <div className="heading-parent">
                ...
                <div className="paragraph3">
                  At Ping Bill Pay, we value your privacy and are committed to
                  protecting your personal information. This Privacy Policy
                  outlines how we collect, use, and safeguard the data you
                  provide to us through our mobile bill pay top-up website. By
              ...
              <div className="heading-parent">
                ...
                <div className="paragraph3">
                  <p className="a-personal-information">
                    (a) Personal Information: When you sign up or use our
                  ...
                  <p className="a-personal-information">
                    ...
                    non-personal information, including browser type, device
                    information, and anonymous usage data, to improve our
              ...
              <div className="heading-parent">
                ...
                <div className="paragraph3">
                  <p className="a-personal-information">
                    (a) Personalization: We use your personal information to
                    personalize your experience and provide customized top-up
                    options based on your preferences and usage history.
                  </p>
                  <p className="a-personal-information">&nbsp;</p>
                  <p className="a-personal-information">
                    (b) Payment Processing: Your billing details are collected
                    and securely processed for facilitating bill payments and
                    top-ups.
                  </p>
                  <p className="a-personal-information">&nbsp;</p>
                  <p className="a-personal-information">
                    (c) Communication: We may use your contact information to
                    send you transactional emails, updates, and promotional
                    offers related to our services. You can opt-out of marketing
                    communications at any time.
                  </p>
                  <p className="a-personal-information">&nbsp;</p>
                  <p className="a-personal-information">
                    (d) Legal Obligations: We may use and disclose your
                    information to comply with legal requirements, enforce our
                    policies, or protect our rights, privacy, safety, or
                    property.
                  </p>
                </div>
              </div>
              <div className="heading-parent">
                ...
                <div className="paragraph3">
                  <p className="a-personal-information">
                    (a) Encryption: We use industry-standard encryption methods
                    to protect your personal and financial information during
                    transmission and storage.
                  </p>
                  <p className="a-personal-information">&nbsp;</p>
                  <p className="a-personal-information">
                    (b) Secure Access: Access to your personal data is limited
                    to authorized personnel only, who are bound by
                    confidentiality obligations.
                  </p>
                  <p className="a-personal-information">&nbsp;</p>
                  <p className="a-personal-information">
                    (c) Third-Party Vendors: We work with trusted third-party
                    vendors to process payments and provide services. We ensure
                    they adhere to strict security standards and only use your
              ...
              <div className="heading-parent">
                ...
                <div className="paragraph3">
                  <p className="a-personal-information">
                    (a) Cookies: Our website may use cookies and similar
                    technologies to collect non-personal information about your
                    browsing behavior. You can adjust your browser settings to
                    manage cookie preferences.
                  </p>
                  <p className="a-personal-information">&nbsp;</p>
                  <p className="a-personal-information">
                    (b) Third-Party Analytics: We may use third-party analytics
                    tools to analyze website usage, but this data is anonymized
              ...
              <div className="heading-parent">
                ...
                <div className="paragraph3">
                  ...
                  will be revised accordingly. We encourage you to review the
                  policy periodically.
                </div>
              </div>
              <div className="heading-parent">
