...
const TremsCondition = () => {
  return (
    <div className="trems-condition">
          ...
          <div className="frame-parent2">
            <div className="content-item-parent2">
              <div className="content-item10">
                <div className="heading14">OVERVIEW</div>
              </div>
              <div className="content-item11">
                <div className="paragraph13">
                  <p className="this-website-is">
                    This website is operated by Celleup, LLC. Throughout the site, the terms “we”, “us” and “our” refer
                    to Celleup, LLC. Celleup, LLC offers this website, including all information, tools and services
                    available from this site to you, the user, conditioned upon your acceptance of all terms,
                    conditions, policies and notices stated here.
                  </p>
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">
                  ...
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">
                    Our store is hosted using AWS using Laravel PHP Framework and Bagisto. Laravel and Bagisto provide
            ...
            <div className="content-item-parent2">
              <div className="content-item10">
                <div className="heading14">ONLINE STORE TERMS</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item10">
                <div className="heading14">GENERAL CONDITIONS</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">MODIFICATIONS TO THE SERVICE AND PRICES</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">Prices for our products are subject to change without notice.</p>
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">PRODUCTS OR SERVICES</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">ACCURACY OF BILLING AND ACCOUNT INFORMATION</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
                  ...
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">For more detail, please review our Returns Policy.</p>
                </div>
              </div>
            </div>
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">OPTIONAL TOOLS</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">THIRD-PARTY LINKS</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">PERSONAL INFORMATION</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">ERRORS, INACCURACIES AND OMISSIONS</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">PROHIBITED USES</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
                  ...
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">
                    In no case shall Celleup, LLC, our directors, officers, employees, affiliates, agents, contractors,
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">INDEMNIFICATION</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  You agree to indemnify, defend and hold harmless Celleup, LLC and our parent, subsidiaries,
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">SEVERABILITY</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">TERMINATION</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
            ...
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">GOVERNING LAW</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  These Terms of Service and any separate agreements whereby we provide you Services shall be governed
                  by and construed in accordance with the laws of 1131 Patricia Dr San Antonio TX 78213 to 4800 Sugar
                  Grove Blvd Stafford, TX 77477
                </div>
              </div>
            </div>
            <div className="content-item-parent2">
              <div className="content-item16">
                <div className="heading14">CHANGES TO TERMS OF SERVICE</div>
              </div>
              <div className="content-item13">
                <div className="paragraph13">
                  <p className="this-website-is">
      ...
      <img className="trems-condition-item" alt="" src="/group-48.svg" />
    </div>
  );
};
