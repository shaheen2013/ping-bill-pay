        ...
        <div className="frame-parent1">
          <div className="frame-parent2">
              ...
              <div className="content-item11">
                <div className="paragraph13">
                  <p className="this-website-is">
                    This website is operated by Celleup, LLC. Throughout the
                    site, the terms “we”, “us” and “our” refer to Celleup, LLC.
                    Celleup, LLC offers this website, including all information,
                  ...
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">
                    Our store is hosted using AWS using Laravel PHP Framework
                    and Bagisto. Laravel and Bagisto provide us with the online
            ...
            <div className="content-item-parent2">
              ...
              <div className="content-item13">
                <div className="paragraph13">
                  ...
                  <p className="this-website-is">&nbsp;</p>
                  <p className="this-website-is">
                    In no case shall Celleup, LLC, our directors, officers,
            ...
            <div className="content-item-parent2">
              ...
              <div className="content-item13">
                <div className="paragraph13">
                  You agree to indemnify, defend and hold harmless Celleup, LLC
            ...
            <div className="content-item-parent2">
              ...
              <div className="content-item13">
                <div className="paragraph13">
                  ...
                  accordance with the laws of 1131 Patricia Dr San Antonio TX
                  78213 to 4800 Sugar Grove Blvd Stafford, TX 77477
                </div>
              </div>
            </div>
            <div className="content-item-parent2">
